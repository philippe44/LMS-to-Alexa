...
Allows Alexa devices to be used in Logitech Media Server.
Pre-packaged versions for Windows (XP and above), Linux (x86, x64 and ARM) and OSX can be found here https://sourceforge.net/projects/lms-to-alexa/ and here https://sourceforge.net/projects/lms-plugins-philippe44/
